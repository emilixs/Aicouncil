...
const EXPERT_TEMPLATES = [
  {
    ...
    config: { model: 'claude-sonnet-4-5-20250514', temperature: 0.5 },
  },
  {
    name: 'Code Reviewer',
    ...
    driverType: DriverType.ANTHROPIC,
    config: { model: 'claude-sonnet-4-5-20250514', temperature: 0.3 },
  },
  {
  ...
  },
  {
    ...
    driverType: DriverType.ANTHROPIC,
    config: { model: 'claude-sonnet-4-5-20250514', temperature: 0.6 },
  },
  {
    name: 'QA Engineer',
    specialty: 'Testing',
