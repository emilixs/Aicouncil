...
export const EXPERT_TEMPLATES: ExpertTemplate[] = [
  ...
  },
  {
    ...
    driverType: DriverType.ANTHROPIC,
    config: { model: 'claude-3-5-sonnet-20241022', temperature: 0.3 },
  },
  {
    id: 'tpl-architect',
  ...
  },
  {
    ...
    driverType: DriverType.ANTHROPIC,
    config: { model: 'claude-3-5-sonnet-20241022', temperature: 0.6 },
  },
  {
    id: 'tpl-qa-engineer',
    name: 'QA Engineer',
    ...
    config: { model: 'grok-4-latest', temperature: 0.4 },
  },
  {
    id: 'tpl-ray-dalio',
    name: 'Ray Dalio',
  ...
  },
  {
    ...
    driverType: DriverType.GROK,
    config: { model: 'grok-4-latest', temperature: 0.8 },
  },
  {
    id: 'tpl-charlie-munger',
    name: 'Charlie Munger',
